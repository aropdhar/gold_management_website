  ...
  return (
    <div className='my-20'>
      <div className='custom-container mx-auto'>
         <div className='flex flex-col lg:flex-row gap-y-4 text-center items-center justify-center bg-[#121111ef] dark:bg-[#1c1b22]  py-10 lg:gap-x-5 text-white rounded-[5px]'>
