    ...
    <div className='bg-white dark:bg-[#1c1b22]  py-[72px]'>
      <div className='custom-container mx-auto'>
        <div className='flex flex-col items-center gap-y-4 justify-center'>
          ...
          <p className='lg:text-[18px] text-center text-[#777]'>Subscribe to our newsletter and get an instant discount code.</p>
          <div className='border-2 border-black dark:border-white relative lg:w-[510px]'>
