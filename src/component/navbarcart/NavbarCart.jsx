...
const NavbarCart = ({cartshow , setcartshow}) => {
  ...
  return (
    <div>
      ...
      <div className={`fixed top-0 right-0 h-full w-[300px] md:w-[410px] bg-[#f5f5f5] dark:bg-[#1c1b22] dark:text-white z-5000 transition-transform  duration-500  ease-in-out ${cartshow ? "translate-x-0" : "translate-x-full"}`}> 
            {/* cart header section */}
